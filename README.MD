...
### Home Page
Interface showing the welcome page with a brief introduction and instructions.

### Prediction Page
Interface allowing users to input product details and store location for predicting sales.
